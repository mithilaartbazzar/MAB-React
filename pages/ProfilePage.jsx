...
export const ProfilePage = ({ currentUser, setCurrentUser, wishlist, products, toggleWishlist, addToCart }) => {
    ...
    const [profile, setProfile] = useState({
        name: currentUser.name || '', username: currentUser.username || '', phone: currentUser.phone || '', address: currentUser.address || '', city: currentUser.city || ''
    });
