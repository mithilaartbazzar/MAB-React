export const PrivacyPolicy=()=> {
  return (
    <div className="max-w-4xl mx-auto mt-[10vh] p-6 text-gray-800">
      ...
      <p className="mb-4">
        When you visit our store or place an order, we may collect certain
        information such as your name, email address, phone number, shipping
        address, and payment details. We may also collect non-personal
        information such as browser type, device information, and website usage
        data.
      </p>
 
      <h2 className="text-xl font-semibold mt-6 mb-2">2. How We Use Your Information</h2>
      <p className="mb-4">
        The information we collect may be used to process orders, provide
        customer support, improve our website and services, send order updates,
        and communicate promotional offers if you choose to receive them.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">3. Sharing Your Information</h2>
      <p className="mb-4">
        We do not sell or trade your personal information. Your information may
        only be shared with trusted third-party services such as payment
        processors, delivery partners, or hosting providers that help us
        operate our store and provide services to you.
      </p>
      ...
      <p className="mb-4">
        ...
        preferences, and analyze website traffic. You can choose to disable
