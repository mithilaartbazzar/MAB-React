                ...
                <div className="grid grid-cols-2 gap-x-5 gap-y-8 sm:gap-10 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr] lg:gap-16">
                    ...
                    <div className="col-span-2 sm:col-span-1">
                        ...
                        <form onSubmit={(e) => e.preventDefault()} className="flex gap-2">
                            <input type="email" required placeholder="Your email..." className="min-w-0 flex-1 rounded-xl border border-white/10 bg-white/5 px-3 py-2.5 text-xs transition-all placeholder:text-stone-600 focus:border-[#5c1111] focus:bg-white/10 focus:outline-none sm:px-4 sm:py-3 sm:text-sm" />
                            <button type="submit" className="shrink-0 rounded-xl bg-[#5c1111] px-3 py-2.5 shadow-lg transition-all hover:-translate-y-0.5 hover:bg-red-700 sm:px-4 sm:py-3" title="Subscribe"><Send size={14} className="sm:h-4 sm:w-4" /></button>
                        </form>
